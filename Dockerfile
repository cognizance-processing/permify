...
ENTRYPOINT ["/app/permify", "serve", "--database-engine", "postgres", "--database-uri", "postgresql:///postgre?host=/cloudsql/cog-analytics-backend:us-central1:permify&user=postgres&password=postgre"]
